...
print("These G4PromFinder version consider only the predict elements closest the CDS")
...
try:
    ...
    try:
        ...
        q = open("Promoter coordinates (Method 2).txt","a")
        ...
        regione.sort()
        with open("ABOUT_PROMOTERS (METHOD 2).txt", "a") as file:
            ...
            file.write("\n\n\nPercentage of genes in which in the upstream intergenic region>=50bp a promoter was predicted ")
            file.write(str(r))
            file.write("%")
            ...
            file.write("\n\n\n\nPercentage of predicted promoters cointaining the pattern TANNNT: ")
            file.write(str(100*SI1/(SI1+NO1)))
            file.write("%\nThe total number of these regions is ")
            file.write(str(SI1))
            file.write("\n\nPercentage of predicted promoters cointaining the pattern TTGAC ")
